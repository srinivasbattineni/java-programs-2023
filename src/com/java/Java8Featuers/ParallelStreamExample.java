...
import com.java.MapReduseExample.Employee;
import com.java.MapReduseExample.EmployeeDatabase;
...
public class ParallelStreamExample {
    ...
    public static void main(String[] args) {
        ...
        IntStream.range(1,100).forEach((IntConsumer) System.out::println);
